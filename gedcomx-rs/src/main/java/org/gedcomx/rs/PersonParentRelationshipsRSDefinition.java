...
/**
 * <p>The person parent relationships resource defines a list of relationships to parents of a person. The person parent relationships
 ...
 */
@ResourceDefinition (
  name = "Person Parent Relationships",
...
public interface PersonParentRelationshipsRSDefinition {

  public static final String REL = Rel.PARENT_RELATIONSHIPS;

  /**
   * Read the set of parent relationships for a specific person.
   *
   * @return The set of parent relationships.
   */
  @GET
  @StatusCodes({
