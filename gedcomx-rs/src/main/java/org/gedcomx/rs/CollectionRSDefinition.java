...
@ResourceDefinition (
  ...
  transitions = {
    @StateTransition( rel = Rel.OAUTH2_AUTHORIZE, description = "The OAuth2 authorization URI.", scope = Collection.class, conditional = true ),
    @StateTransition( rel = Rel.OAUTH2_TOKEN, description = "The OAuth2 token URI.", scope = Collection.class, conditional = true ),
    ...
    @StateTransition( rel = ArtifactsRSDefinition.REL, description = "The artifacts in this collection.", scope = Collection.class, conditional = true, targetResource = ArtifactsRSDefinition.class ),
    @StateTransition( rel = SourceDescriptionsRSDefinition.REL, description = "The source descriptions in this collection.", scope = Collection.class, conditional = true, targetResource = SourceDescriptionsRSDefinition.class ),
