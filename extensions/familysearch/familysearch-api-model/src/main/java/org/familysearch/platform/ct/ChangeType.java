...
public enum ChangeType {
  ...
  */
  ...
  ADD_ADOPTIVE_PARENT("Adoptive Parent Added", ChangeOperation.Create, ChangeObjectType.AdoptiveParent, ChangeObjectModifier.ChildAndParentsRelationship),
  EDIT_ADOPTIVE_PARENT("Adoptive Parent Changed", ChangeOperation.Update, ChangeObjectType.AdoptiveParent, ChangeObjectModifier.ChildAndParentsRelationship),
  DELETE_ADOPTIVE_PARENT("Adoptive Parent Removed", ChangeOperation.Delete, ChangeObjectType.AdoptiveParent, ChangeObjectModifier.ChildAndParentsRelationship),
  ADD_BIOLOGICAL_PARENT("Biological Parent Added", ChangeOperation.Create, ChangeObjectType.BiologicalParent, ChangeObjectModifier.ChildAndParentsRelationship),
  EDIT_BIOLOGICAL_PARENT("Biological Parent Changed", ChangeOperation.Update, ChangeObjectType.BiologicalParent, ChangeObjectModifier.ChildAndParentsRelationship),
  DELETE_BIOLOGICAL_PARENT("Biological Parent Removed", ChangeOperation.Delete, ChangeObjectType.BiologicalParent, ChangeObjectModifier.ChildAndParentsRelationship),
  ADD_FOSTER_PARENT("Foster Parent Added", ChangeOperation.Create, ChangeObjectType.FosterParent, ChangeObjectModifier.ChildAndParentsRelationship),
  EDIT_FOSTER_PARENT("Foster Parent Changed", ChangeOperation.Update, ChangeObjectType.FosterParent, ChangeObjectModifier.ChildAndParentsRelationship),
  DELETE_FOSTER_PARENT("Foster Parent Removed", ChangeOperation.Delete, ChangeObjectType.FosterParent, ChangeObjectModifier.ChildAndParentsRelationship),
  ADD_GUARDIAN_PARENT("Guardian Parent Added", ChangeOperation.Create, ChangeObjectType.GuardianParent, ChangeObjectModifier.ChildAndParentsRelationship),
  EDIT_GUARDIAN_PARENT("Guardian Parent Changed", ChangeOperation.Update, ChangeObjectType.GuardianParent, ChangeObjectModifier.ChildAndParentsRelationship),
  DELETE_GUARDIAN_PARENT("Guardian Parent Removed", ChangeOperation.Delete, ChangeObjectType.GuardianParent, ChangeObjectModifier.ChildAndParentsRelationship),
  ADD_STEP_PARENT("Step Parent Added", ChangeOperation.Create, ChangeObjectType.StepParent, ChangeObjectModifier.ChildAndParentsRelationship),
  EDIT_STEP_PARENT("Step Parent Changed", ChangeOperation.Update, ChangeObjectType.StepParent, ChangeObjectModifier.ChildAndParentsRelationship),
  DELETE_STEP_PARENT("Step Parent Removed", ChangeOperation.Delete, ChangeObjectType.StepParent, ChangeObjectModifier.ChildAndParentsRelationship),
