 ...
 * @author Ryan Heaton
 */
class EvidenceRecipesTest extends RecipeTest {

  /**
   * tests citing an online record.
   */
  @Test
  void citingOnlineArtifact() throws Exception {
   ...
   */
  @Test
  void citingPhysicalArtifact() throws Exception {
   ...
   */
  @Test
  void conclusionsCitingOtherConclusions() throws Exception {
